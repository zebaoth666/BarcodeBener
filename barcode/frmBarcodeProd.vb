...
Public Class frmBarcodeProd
    ...
    Private Sub loadBrand()
        ...
        'Dim array(,) As String = {{"01", "Buccheri"}, {"02", "Vigano"}, {"03", "Milano"}, {"04", "Vicari"}}
        dtBrand.Rows.Add({"01", "Buccheri"}, {"02", "Vigano"}, {"03", "Milano"}, {"04", "Vicari"})
        aktif =True
    End Sub
    ...
    Private Sub loadStyle()
        If aktif Then
            ...
            'command.Connection = loadConnection
            'command.CommandText = "select style_id kd_style, style_description nm_style from m_style" &
            ...
            'End If
            dtStyle.Rows.Add({"01", "Style 1"}, {"02", "Style 2"}, {"03", "Style 3"}, {"04", "Style 4"})
        End If
    End Sub
    ...
    Private Sub loadColor()
        ...
        'dtColor.Rows.Add({"01", "Hitam"}, {"02", "Cokelat"}, {"03", "Beige"}, {"04", "Maroon"})
    End Sub
    ...
    Private Sub loadSize()
        ...
        'dtSize.Rows.Add({"01", "38"}, {"02", "39"}, {"03", "40"}, {"04", "41"})
    End Sub
